...
const SCREENS: ScreenEntry[] = [
  ...
  // Dev Tools
  { route: '/dev/debug-panel', label: 'Debug Panel', icon: 'bug-outline', section: 'settings' },
...
export default function UIPreview() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView
        contentContainerStyle={[styles.content, { paddingTop: insets.top + (spacing[4] ?? 16), paddingBottom: insets.bottom + (spacing[8] ?? 32) }]}
