...
import Animated, { FadeIn, FadeInDown, FadeInUp, FadeInRight, ZoomIn, SlideInDown } from 'react-native-reanimated';
...
import { GlassCard, GradientButton, ProgressRing, PulseDot, SectionHeader } from '../src/components/ui/GlassUI';
  ...
  useEffect(() => {
    if (isReady && userProfile && status === 'idle' && !completionResult && !autoGeneratedRef.current) {
      ...
      if (Date.now() - lastAutoGeneratedAt < AUTO_GEN_COOLDOWN_MS) {
        if (__DEV__) console.log('[FitQuest] Auto-gen skipped (cooldown active)');
        return;
      }
