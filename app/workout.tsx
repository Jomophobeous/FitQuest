...
const styles = StyleSheet.create({
  ...
  metaText: { fontSize: typography.sizes.caption, fontWeight: '600', fontVariant: ['tabular-nums' as const] },
  ...
  progressPercent: { fontSize: typography.sizes.h1Sm, fontWeight: '800', fontVariant: ['tabular-nums' as const] },
  ...
  exerciseTimerText: { fontSize: typography.sizes.h3, fontWeight: '800', fontVariant: ['tabular-nums' as const] },
