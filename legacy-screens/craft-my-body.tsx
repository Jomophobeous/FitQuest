        ...
        <View style={styles.inputRow}>
          <View style={styles.inputGroup}>
            ...
            {!!fieldErrors.heightCm && (
              <Text style={{ color: colors.error, fontSize: typography.sizes.captionSm, marginTop: spacing[0.5] }}>{fieldErrors.heightCm}</Text>
            )}
          </View>
          <View style={styles.inputGroup}>
            ...
            {!!fieldErrors.weightKg && (
              <Text style={{ color: colors.error, fontSize: typography.sizes.captionSm, marginTop: spacing[0.5] }}>{fieldErrors.weightKg}</Text>
            )}
          </View>
          <View style={styles.inputGroup}>
            ...
            />
            {!!fieldErrors.age && (
              <Text style={{ color: colors.error, fontSize: typography.sizes.captionSm, marginTop: spacing[0.5] }}>{fieldErrors.age}</Text>
            )}
          </View>
        </View>
      </GlassCard>
      ...
      <Animated.View entering={FadeInDown.duration(150)} key="step-results">
        ...
        <GlassCard style={styles.card}>
          ...
          <Text style={[styles.caloriesBig, { color: colors.text }]}>
            {algorithm.calories_target} <Text style={{ fontSize: typography.sizes.body, color: colors.textMuted }}>kcal/day</Text>
          </Text>
...
const styles = StyleSheet.create({
  ...
  // Goal rows
  goalRow: { flexDirection: 'row', alignItems: 'center', gap: spacing[4], borderRadius: 8, borderWidth: 1, padding: spacing[2] },
  ...
  muscleCard: { width: '47%' as any, alignItems: 'center', padding: spacing[4], borderRadius: 12, minWidth: 150 },
  muscleLabel: { fontSize: typography.sizes.label, fontWeight: '600', marginTop: spacing[2], marginBottom: spacing[2] },
  priorityBadge: { paddingHorizontal: spacing[2], paddingVertical: spacing[0.5], borderRadius: 8 },
  ...
  scheduleDay: { flex: 1, alignItems: 'center', paddingVertical: spacing[2], borderRadius: 8 },
