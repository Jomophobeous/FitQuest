        ...
        <SafeAreaView style={styles.thankYouSafe}>
          <Animated.View entering={FadeIn.duration(300)} style={styles.thankYouCenter}>
            ...
            <Animated.View entering={FadeInDown.delay(200).duration(300)}>
              ...
              <Text style={[styles.thankYouMessage, { color: theme.colors.textMuted, marginTop: spacing[2], fontSize: typography.sizes.label }]}>
          ...
          >
            ...
            {category && (
              <Animated.View entering={FadeInDown.duration(200)}>
                <Text style={[styles.sectionLabel, { color: theme.colors.textSecondary, marginTop: spacing[5] }]}>
                  Tell us more
                </Text>
                <View
                  style={[
            ...
            <Animated.View entering={FadeInDown.delay(300).duration(200)} style={styles.quickLinks}>
              <Text style={[styles.sectionLabel, { color: theme.colors.textSecondary, marginTop: spacing[6] }]}>
                Quick Links
              </Text>
              <TouchableOpacity
                style={[
