...
function FitQuestScreenInner() {
  ...
  useEffect(() => {
    if (isReady && userProfile && status === 'idle' && !completionResult && !autoGeneratedRef.current) {
      ...
      const timer = setTimeout(() => generateNewWorkoutRef.current(), 500); // debounce
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
        ...
        {currentExercise.mindTimeline ? (
          ...
          >
            ...
            >
              <Text style={{ color: theme.colors.textMuted, fontSize: typography.sizes.label }}>{t('fitquest.cancelWorkout')}</Text>
            </TouchableOpacity>
          </ScrollView>
        )}
      </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  deloadBadge: { paddingHorizontal: spacing[3], paddingVertical: spacing[1.25], borderRadius: 8 },
  ...
  skipRestButton: { marginTop: spacing[3], paddingHorizontal: spacing[5], paddingVertical: spacing[2], borderRadius: 8, borderWidth: 1 },
