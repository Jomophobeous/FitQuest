        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {vm.jogError && (
            <GlassCard style={styles.errorCard} glowColor={theme.colors.error} delay={150}>
              <Text style={[styles.errorText, { color: theme.colors.error }]}>{vm.jogError}</Text>
              <GradientButton
            ...
            <View style={styles.stepHeroInner}>
              ...
              <View style={styles.stepDetails}>
                <Animated.View entering={ZoomIn.delay(200).duration(150)}>
                  <Text style={[styles.stepCount, { color: theme.colors.text }]}>{vm.todaySteps.toLocaleString()}</Text>
                </Animated.View>
                ...
                <View style={styles.stepMiniStats}>
                  <View style={[styles.miniStat, { backgroundColor: theme.colors.accent + '15' }]}>
                    ...
                    <Text style={[styles.miniStatText, { color: theme.colors.accent }]}>{vm.distKm} km</Text>
                  </View>
                  <View style={[styles.miniStat, { backgroundColor: theme.colors.accent2 + '15' }]}>
                    ...
                    <Text style={[styles.miniStatText, { color: theme.colors.accent2 }]}>{vm.calories} cal</Text>
                  </View>
                  <View style={[styles.miniStat, { backgroundColor: theme.colors.accent3 + '15' }]}>
                    ...
                    <Text style={[styles.miniStatText, { color: theme.colors.accent3 }]}>{vm.activeMin} min</Text>
                  </View>
                </View>
              </View>
            </View>
          ...
          <Animated.View entering={FadeInDown.delay(150).duration(150)}>
            <GlassCard style={{ marginHorizontal: spacing[4], marginTop: spacing[3], padding: spacing[4] }}>
              ...
              >
                <Text style={{ fontSize: typography.sizes.bodyMid, fontWeight: '700', color: theme.colors.text }}>This Week</Text>
                <Text style={{ fontSize: typography.sizes.caption, color: theme.colors.textMuted }}>
                ...
                <Animated.View entering={FadeInDown.duration(150)} style={sensorStyles.metricsRow}>
                  ...
                  {vm.sensorSnapshot.activity === 'EXERCISE' && (
                    <View style={[sensorStyles.metricBox, { backgroundColor: theme.colors.surfaceVariant }]}>
                      ...
                      <Text style={[sensorStyles.metricValue, { color: theme.colors.text }]}>{vm.sensorSnapshot.repCount}</Text>
                      <Text style={[sensorStyles.metricLabel, { color: theme.colors.textMuted }]}>
                        {t('move.reps')}
                      </Text>
                    </View>
              ...
              {vm.isJogging && vm.currentJog ? (
                <Animated.View entering={FadeInDown.duration(150)} style={styles.activeJog}>
                  <View style={styles.jogTimerDisplay}>
                    <Text style={[styles.jogTimerText, { color: theme.colors.success }]}>{vm.jogElapsed}</Text>
                  </View>
                  ...
                  <View style={styles.jogLiveStats}>
                    ...
                    {vm.jogStats?.currentPaceSecondsPerKm ? (
                      ...
                      <View style={styles.jogStat}>
                        <Text style={[styles.jogStatValue, { color: theme.colors.accent2 }]}>{vm.cadence}</Text>
                  ...
                  {vm.jogStats && vm.showLiveMap && (
                    <Animated.View entering={FadeIn.duration(200)}>
                      ...
                      >
                        <Text style={{ fontSize: typography.sizes.label, fontWeight: '600', color: theme.colors.textSecondary }}>
                          Route Map
                        </Text>
                        <TouchableOpacity
                  ...
                  {vm.jogStats && !vm.showLiveMap && (
                    ...
                    >
                      ...
                      <Text style={{ fontSize: typography.sizes.label, fontWeight: '600', color: theme.colors.accent }}>Show Map</Text>
                    </TouchableOpacity>
                  )}
                    ...
                    >
                      <View style={{ flex: 1 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing[1.5], marginTop: spacing[0.5] }}>
                          <Text style={[{ fontSize: typography.sizes.captionSm, color: theme.colors.textMuted }]}>
...
const styles = StyleSheet.create({
  ...
  errorCard: { marginHorizontal: spacing[4], padding: spacing[4], borderRadius: 16, marginTop: spacing[3] },
