...
const PUSH_EXERCISES: Partial<GeneratedExercise>[] = [
  // Wall push-ups (beginner)
  {
    ...
    instructions: [
      'Stand arm-length from wall, feet together.',
  ...
  {
    name: 'Wall Push-up Narrow Grip',
    difficulty: 'beginner',
    equipment_level: 'none',
    primary_muscles: ['triceps', 'chest_mid'],
    secondary_muscles: ['deltoids_front', 'core_deep'],
    instructions: [
      'Hands close together on wall.',
      'Elbows stay close to body.',
      'Lower slowly.',
      'Push back focusing on triceps.',
    ],
    time_per_set_seconds: 30,
  },
  ...
  },
  {
    ...
    instructions: ['Wide hand placement on bench.', 'Lower with control.', 'Feel chest stretch.', 'Press up.'],
    time_per_set_seconds: 35,
  },
  {
    ...
    equipment_required: ['bench'],
    instructions: [
      'Diamond hand position on bench.',
  ...
  },
  {
    ...
    primary_muscles: ['chest_mid', 'chest_upper'],
    secondary_muscles: ['triceps', 'deltoids_front'],
    instructions: ['Wide hand placement.', 'Knees supporting.', 'Lower with chest focus.', 'Push up.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Knee Push-up Close Grip',
    difficulty: 'beginner',
    equipment_level: 'none',
    primary_muscles: ['triceps', 'chest_mid'],
    secondary_muscles: ['deltoids_front', 'core_deep'],
    instructions: ['Hands close together.', 'Elbows stay close.', 'Lower controlled.', 'Triceps drive the push.'],
    time_per_set_seconds: 30,
  },
  ...
  },
  {
    ...
    primary_muscles: ['chest_mid', 'chest_upper'],
    secondary_muscles: ['triceps', 'deltoids_front'],
    instructions: ['Hands wider than shoulders.', 'Lower with chest stretch.', 'Keep core tight.', 'Push up.'],
    time_per_set_seconds: 35,
  },
  {
    ...
    primary_muscles: ['triceps', 'chest_mid'],
    secondary_muscles: ['deltoids_front', 'core_deep'],
    instructions: ['Hands form diamond shape.', 'Elbows stay close.', 'Lower slowly.', 'Push up through triceps.'],
    time_per_set_seconds: 35,
  },
  {
    ...
    primary_muscles: ['chest_mid', 'triceps'],
    secondary_muscles: ['deltoids_front', 'core_deep'],
    instructions: ['One hand forward, one back.', 'Lower evenly.', 'Push up.', 'Alternate hand positions.'],
  ...
  },
  {
    ...
    secondary_muscles: ['triceps', 'traps_mid'],
    instructions: [
  ...
  },
  {
    ...
    instructions: ['Standard push-up position.', 'Explosive push off floor.', 'Clap hands mid-air.', 'Land softly.'],
    time_per_set_seconds: 40,
  },
  {
...
const PULL_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  },
  {
    ...
    equipment_required: ['pull_up_bar'],
    instructions: ['Hang from bar.', 'Engage lats and depress shoulders.', 'Keep core tight.', 'Hold position.'],
    time_per_set_seconds: 30,
  },
  {
  ...
  },
  {
    ...
    equipment_required: ['pull_up_bar', 'band'],
    instructions: [
      'Loop band around bar.',
  ...
  },
  {
    ...
    secondary_muscles: ['biceps', 'traps_mid'],
    equipment_required: ['table'],
    instructions: ['Lie under sturdy table.', 'Grip edge, body straight.', 'Pull chest to table.', 'Lower slowly.'],
    time_per_set_seconds: 35,
  },
  {
    ...
    equipment_required: ['pull_up_bar'],
    instructions: [
      'Grip bar lengthwise (hands in line).',
  ...
  },
  {
    ...
    secondary_muscles: ['forearms', 'core_deep'],
    equipment_required: ['pull_up_bar'],
    instructions: ['Start at top of chin-up.', 'Release one hand.', 'Lower as slowly as possible.', 'Alternate arms.'],
    time_per_set_seconds: 45,
  },
];
...
const LEG_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  },
  {
    ...
    instructions: ['Back against wall.', 'Slide down to 90 degree knees.', 'Hold position.', 'Quads on fire.'],
    time_per_set_seconds: 45,
  },
  {
    name: 'Glute Bridge',
  ...
  },
  {
    ...
    instructions: ['Stand on flat ground.', 'Rise onto balls of feet.', 'Squeeze at top.', 'Lower slowly.'],
    time_per_set_seconds: 25,
  },
  {
    ...
    instructions: ['Step into lunge position.', 'Both knees at 90 degrees.', 'Hold position.', 'Switch legs.'],
    time_per_set_seconds: 40,
  },
  {
  ...
  },
  {
    ...
    impact_level: 'high_impact',
    instructions: ['Squat down.', 'Explode upward into jump.', 'Land softly.', 'Immediately descend into next rep.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Box Jump',
    ...
    equipment_required: ['bench'],
    impact_level: 'high_impact',
    instructions: ['Stand facing box.', 'Swing arms and jump onto box.', 'Land softly with bent knees.', 'Step down.'],
    time_per_set_seconds: 35,
  },
  {
    name: 'Nordic Curl',
...
const CORE_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  },
  {
    ...
    instructions: ['On hands and knees.', 'Extend opposite arm and leg.', 'Keep hips level.', 'Return and alternate.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Plank',
  ...
  },
  {
    ...
    instructions: ['Lie on back, knees bent.', 'Hands behind head.', 'Curl shoulders off floor.', 'Lower controlled.'],
    time_per_set_seconds: 25,
  },
  {
    ...
    instructions: ['Lie on back, knees bent.', 'Lift hips and hold.', 'Squeeze glutes.', 'Maintain position.'],
    time_per_set_seconds: 30,
  },
  ...
  },
  {
    ...
    instructions: ['High plank position.', 'Drive knee toward chest.', 'Alternate rapidly.', 'Keep hips low.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Leg Raise',
  ...
  },
  {
    ...
    instructions: ['Lie on back.', 'Raise legs and shoulders off floor.', 'Form banana shape.', 'Hold position.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'V-up',
  ...
  },
  {
    ...
    equipment_required: ['pull_up_bar'],
    instructions: ['Hang from bar.', 'Raise straight legs to 90 degrees.', 'Lower with control.', 'Avoid swinging.'],
    time_per_set_seconds: 40,
  },
  {
    name: 'Toes to Bar',
  ...
  },
  {
    ...
    equipment_level: 'minimal',
    primary_muscles: ['abs', 'core_deep'],
    secondary_muscles: ['lats', 'deltoids_front'],
  ...
  },
  {
    ...
    equipment_required: ['pull_up_bar'],
    instructions: ['Hang from bar.', 'Raise legs to L-sit.', 'Rotate legs side to side.', 'Control the movement.'],
    time_per_set_seconds: 45,
  },
];
...
const FLEXIBILITY_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  // Lower body stretches
  {
    ...
    secondary_muscles: ['ankle'],
    instructions: ['Stand on one leg.', 'Pull foot to glutes.', 'Keep knees together.', 'Hold and switch.'],
    time_per_set_seconds: 30,
  },
  {
  ...
  },
  {
    ...
    instructions: ['Kneel on one knee.', 'Front foot flat, knee at 90.', 'Push hips forward.', 'Hold and switch.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Pigeon Pose',
  ...
  },
  {
    ...
    instructions: ['Sit with legs extended.', 'Hinge at hips forward.', 'Reach for toes.', 'Hold and breathe.'],
    time_per_set_seconds: 45,
  },
  {
    name: 'Frog Stretch',
    ...
    primary_muscles: ['adductors', 'hip_flexors'],
    secondary_muscles: ['glutes_med'],
    instructions: ['On hands and knees.', 'Spread knees wide apart.', 'Lower hips toward floor.', 'Hold and breathe.'],
    time_per_set_seconds: 45,
  },
  {
  ...
  // Full body stretches
  {
    ...
    secondary_muscles: ['chest_mid', 'spinal_erectors', 'obliques'],
    instructions: [
  ...
  },
  {
    ...
    instructions: ['Lie face down.', 'Push chest up, hips stay down.', 'Arch lower back.', 'Hold and breathe.'],
    time_per_set_seconds: 30,
  },
  {
...
const POSTURE_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  },
  {
    ...
    instructions: ['Lie face down.', 'Raise arms in Y shape.', 'Squeeze shoulder blades.', 'Lower and repeat.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Prone T Raise',
...
const SPEED_EXERCISES: Partial<GeneratedExercise>[] = [
  {
    ...
    impact_level: 'high_impact',
    instructions: ['Run in place.', 'Drive knees high toward chest.', 'Pump arms.', 'Stay on balls of feet.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Butt Kicks',
    ...
    impact_level: 'high_impact',
    instructions: ['Run in place.', 'Kick heels to glutes.', 'Keep knees down.', 'Quick tempo.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'Jumping Jacks',
  ...
  },
  {
    ...
    secondary_muscles: ['adductors', 'calves_gastrocnemius'],
    space_required: 'small_bedroom_2x2',
    instructions: ['Athletic stance, knees bent.', 'Shuffle sideways quickly.', 'Stay low.', 'Switch direction.'],
    time_per_set_seconds: 30,
  },
  {
    name: 'A-Skip',
...
const MENTAL_CLARITY_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  },
  {
    ...
    secondary_muscles: ['vagus_nerve'],
    space_required: 'small_bedroom_2x2',
    instructions: ['Walk very slowly.', 'Feel each part of step.', 'Heel, ball, toe.', 'Stay present in body.'],
    time_per_set_seconds: 120,
  },
  {
...
const MUSCLE_BUILDING_EXERCISES: Partial<GeneratedExercise>[] = [
  ...
  {
    name: 'Tempo Push-up (4-1-2)',
    difficulty: 'intermediate',
    equipment_level: 'none',
    primary_muscles: ['chest_mid', 'triceps'],
    secondary_muscles: ['deltoids_front', 'core_deep'],
    instructions: ['4 seconds down.', '1 second pause at bottom.', '2 seconds up.', 'Focus on muscle tension.'],
    time_per_set_seconds: 45,
  },
  {
    name: 'Tempo Squat (3-2-1)',
    difficulty: 'intermediate',
    equipment_level: 'none',
    primary_muscles: ['quads', 'glutes_max'],
    secondary_muscles: ['hamstrings', 'core_deep'],
    instructions: ['3 seconds down.', '2 second pause at bottom.', '1 second up explosively.', 'Feel the burn.'],
    time_per_set_seconds: 45,
  },
  {
  ...
  },
  {
    ...
    secondary_muscles: ['hamstrings', 'lower_back'],
    equipment_required: ['backpack'],
    instructions: ['Wear loaded backpack.', 'Perform squats.', 'Keep chest up.', 'Full depth.'],
    time_per_set_seconds: 40,
  },
  {
    name: 'Weighted Lunge',
    ...
    secondary_muscles: ['hamstrings', 'hip_flexors'],
    equipment_required: ['backpack'],
    instructions: ['Wear loaded backpack.', 'Perform lunges.', 'Step forward or backward.', 'Alternate legs.'],
    time_per_set_seconds: 40,
  },
  {
...
function generateExercisesForCategory(
  ...
  return templates.map((template, i) => ({
    ...
    training_types: template.training_types || [{ type: 'strength', effectiveness: 5 }],
...
export function generateAllExercises(): GeneratedExercise[] {
  ...
  if (__DEV__) console.warn(`[ExerciseGenerator] Generated ${allExercises.length} exercises`);
  return allExercises;
}
