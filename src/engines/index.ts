...
// EDGE-CASE GUARDS
export {
  findValidExercisesWithGuards,
  ensureDeloadQuality,
  validateWorkoutCanGenerate,
  getEmergencyFallbackExercise,
  GUARD_CONFIG,
  type GuardResult,
} from './edgeCaseGuards';
...
export {
  ...
  explainProgressionDecision,
  explainDeloadStatus,
  explainMuscleRecovery,
...
export {
  ...
  getResetSummary,
  archiveProgressionForGoalChange,
  hasArchivedData,
  STATE_LIFECYCLE,
  RESET_CONSEQUENCES,
  STATE_RESET_DOCTRINE,
  type ProfileChangeType,
} from './stateResetDoctrine';
