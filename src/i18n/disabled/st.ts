...
const st: Record<string, string> = {
  ...
  'onboarding.perm.battery': 'Tshebetso ya Ka Morao',
  'onboarding.perm.batterySub': 'Lumella ho latela mehato le ho hlahloba bophelo ka morao',

  // Move screen
  'move.vm.cadence': 'Lebelo la Mehato',
  'move.vm.jogHistory': 'Nalane ya ho Matha',
  'move.vm.stepHistory': 'Nalane ya Mehato',
  'move.jogStopError': 'Ho hlolehile ho emisa seboka sa ho matha',
  'move.loadFailed': 'Ho hlolehile ho laela data ya motsamao',

  // Profile screen
  'profile.loading': 'E laela profaele...',
  'profile.subscribed': 'O ngodisitswe',
  'profile.fullAccess': 'Phihlello e feletseng ho tse ling le tse ling',
  'profile.analytics': 'Tlhahlobo ya Tshebediso',
  'profile.analyticsOn': 'E romela data ya tshebediso e sa tsejweng',
  'profile.analyticsOff': 'Pokello ya data ya tshebediso e timetswe',
  'profile.biometricFailed': 'Netefatso ya biometric e hlolehile',
  'profile.loadFailed': 'Ho hlolehile ho laela profaele',
  'profile.trial': 'Nako ya Teko',
  'profile.trialAccess': 'Phihlello e lekantsweng ya teko',

  // Dashboard
  'dashboard.quickStartNudge': 'O lokile ho ikoetlisa?',
  'dashboard.quickStartSub': 'Qala boikoetliso ba hao ba pele ho aha matla',
  'dashboard.recoveryDay': 'Letsatsi la Tsosoloso',
  'dashboard.recoverySub': 'Mmele oa hao o hloka ho phomola — nka bonolo kajeno',
  'dashboard.resumeWorkout': 'Tswela Pele Boikoetliso',
  'dashboard.resumeWorkoutSub': 'Tswela pele moo o emileng teng',
  'dashboard.weeklyGoal': 'Sepheo sa Beke',

  // Workout
  'workout.completed': 'Boikoetliso bo Phethilwe',
  'workout.generating': 'E hlahisa boikoetliso...',

  // FitQuest engine
  'fitquest.adaptiveMemory': 'Mohopolo o Ikamahanyetsang',
  'fitquest.aiInsight': 'Kutloisiso ya AI',

  // Common
  'common.errorLoadingData': 'Phoso ha ho laelwa data',

  // Paywall
  'paywall.purchaseFailed': 'Theko e hlolehile. Ka kopo leka hape.',
  'paywall.restoreFailed': 'Tsosoloso e hlolehile. Ka kopo leka hape.',

  // Progress
  'progress.cameraFailed': 'Ho hlolehile ho bula khamera',
  'progress.galleryFailed': 'Ho hlolehile ho bula sekgahla',
  'progress.saveFailed': 'Ho hlolehile ho boloka senepe sa tsoelo-pele',

  // Register
  'register.invalidPassword': 'Phasewete e tlameha ho ba le ditlhaku tse 8 bonyane',

  // Saved Workouts
  'savedWorkouts.loading': 'E laela boikoetliso bo bolokilweng...',
};
