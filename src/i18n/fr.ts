...
const fr: Record<string, string> = {
  ...
  'onboarding.perm.battery': 'Activité en arrière-plan',
  'onboarding.perm.batterySub': 'Autoriser le suivi des pas et la surveillance de la santé en arrière-plan',

  // Move screen
  'move.vm.cadence': 'Cadence',
  'move.vm.jogHistory': 'Historique de course',
  'move.vm.stepHistory': 'Historique des pas',
  'move.jogStopError': "Échec de l'arrêt de la session de course",
  'move.loadFailed': 'Échec du chargement des données de mouvement',

  // Profile screen
  'profile.loading': 'Chargement du profil...',
  'profile.subscribed': 'Abonné',
  'profile.fullAccess': 'Accès complet à toutes les fonctionnalités',
  'profile.analytics': "Analyse d'utilisation",
  'profile.analyticsOn': "Envoi de données d'utilisation anonymes",
  'profile.analyticsOff': "Collecte de données d'utilisation désactivée",
  'profile.biometricFailed': "L'authentification biométrique a échoué",
  'profile.loadFailed': 'Échec du chargement du profil',
  'profile.trial': 'Essai',
  'profile.trialAccess': "Accès d'essai limité",

  // Dashboard
  'dashboard.quickStartNudge': "Prêt à s'entraîner ?",
  'dashboard.quickStartSub': 'Commencez votre premier entraînement pour créer de la dynamique',
  'dashboard.recoveryDay': 'Jour de récupération',
  'dashboard.recoverySub': "Votre corps a besoin de repos — prenez-le doucement aujourd'hui",
  'dashboard.resumeWorkout': "Reprendre l'entraînement",
  'dashboard.resumeWorkoutSub': 'Continuez là où vous vous êtes arrêté',
  'dashboard.weeklyGoal': 'Objectif hebdomadaire',

  // Workout
  'workout.completed': 'Entraînement terminé',
  'workout.generating': "Génération de l'entraînement...",

  // FitQuest engine
  'fitquest.adaptiveMemory': 'Mémoire adaptative',
  'fitquest.aiInsight': 'Aperçu IA',
  ...
  'paywall.restoreFailed': 'La restauration a échoué. Veuillez réessayer.',

  // Progress
  'progress.cameraFailed': "Échec de l'ouverture de la caméra",
  'progress.galleryFailed': "Échec de l'ouverture de la galerie",
  'progress.saveFailed': 'Échec de la sauvegarde de la photo de progrès',

  // Register
  'register.invalidPassword': 'Le mot de passe doit comporter au moins 8 caractères',
